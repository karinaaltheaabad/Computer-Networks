...
# Student Name: Karina Althea F. Abad
...
class Client(object):
    ...
    def __init__(self):
        ...
        self.client_id = None
        self.student_name = "Karina Althea F. Abad"
        self.github_username = "karinaaltheaabad"
        self.sid = 918533530
    ...
    def set_client_id(self):
        """
        Sets the client id assigned by the server to this client after a successful connection
        :return:
        """
    ...
    def bind(self, param, client_port_to_bind):
        pass
