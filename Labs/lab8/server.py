...
class Server(object):
    ...
    def __init__(self, ip_address='127.0.0.1', port=4988):
        """
        Class constructor
        :param ip_address:
        :param port:
    ...
    def _accept_clients(self):
        ...
        while True:
            ...
            try:
                ...
                threading.Thread(target=self.uploader_handler_thread, args=(clienthandler, addr)).start()
    ...
    def uploader_handler_thread(self, clientsocket, address):
        """
