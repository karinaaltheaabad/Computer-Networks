"""
This file implements the Torrent class which methods handle all the metainfo from the torrent file

USAGE: torrent = Torrent("path to your torrent file")
       info_hash = torrent.info_hash() # gets the info hash of the torrent
       announce = torrent.announce() # gets the main tracker/node
       ......
...
class Torrent:
    ...
    def __init__(self, torrent_path):
        ...
        :param torrent_path: the path to your torrent file
        """
    ...
    def path_to_temp(self):
        """
        :return: the path of your temporal file
        Note: temporal files are the one used to save completed and verified (via hash) pieces.
        """
    ...
    def path_to_tmp_blocks(self):
        """
        :return: The path to your routing table where you save the tmp blocks (lab 9)
        """
