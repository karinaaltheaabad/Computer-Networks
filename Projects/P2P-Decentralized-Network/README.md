...
* Karina Abad - 918533530
* This project is for students to implement their understanding on P2P decentralized networks where each peer can upload and download files to other peers within a network located within the same region. 
* I did not use any other libraries, I attempted to use bencode but failed to implement correctly. 
* Python 3.7
* To run the project, you may run from your IDE, I used Pycharm, so you may open peer.py and run from there, or you may also open a terminal and within the directory run python3 peer.py
* This project was tough. 

  From this, I think I've learned well that high level implementation was insufficient to my understanding due to the lack of missing pieces of knowledge that I have. I failed to understand from the point of view of lab 8 and then to transition to having to automatically connect seeders and peers. From there I couldn't move forward to handling the files. The project is not done, and given the time researching and implementing if I had more time to devote to this project, it would have been fun and full of experience that I had hoped to show to employers. I definitely lost here, but this class was great, and I wish I would have taken it with less important classes so I would have paid further attention and time to it, but thank you for your time and all the help, Jose! I'm sorry that for this class (project), I let you down. 
