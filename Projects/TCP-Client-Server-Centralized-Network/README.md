...
* Karina Abad, Student id: 918533530
* This project is supposed to solidify our understanding in protocols, and the communication between client and servers through TCP/IP. 
* No external modules, only used imports of pickly, threading, socket.   
* Python 3.7 (ran with python3)
* Terminal GIF's of both clients connecting to the server and outputting the menu. 

![client1](https://user-images.githubusercontent.com/41707519/87090234-7eae0d80-c1ec-11ea-8838-7a79788c0a72.gif)
![client2](https://user-images.githubusercontent.com/41707519/87090269-88d00c00-c1ec-11ea-80b0-6d279ad1b3c3.gif)
![server](https://user-images.githubusercontent.com/41707519/87090278-8a99cf80-c1ec-11ea-8bc7-2af488c854da.gif)


* Unfortunately, the whole project was challenging for me. First, I couldn't get the ModuleNotFound error because of a protocol I failed to implement. I couldn't understand what protocol meant and when I finally did I wasted too much time searching up what it meant and figuring out how to do it. Then, I was able to connect the server and the client, but failed to pull information and get the menu actually working as I got lost with where I'm sending the objects to as there was 2 menu.py files in both sub directories. I accept my low grade on this project, however I still hope to work on it and continue to implement it to prove by the end of the semester, this class and what I'll learn, is of great importance to me. I also failed to ask for help because I was supposed to implement this myself, however my knowledge and understanding was insufficient to properly get the program up and running. 
